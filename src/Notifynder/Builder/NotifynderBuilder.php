...
use Boparaiamrit\Notifynder\Exceptions\EntityNotIterableException;
use Boparaiamrit\Notifynder\Exceptions\IterableIsEmptyException;
use Boparaiamrit\Notifynder\Exceptions\NotificationBuilderException;
use Carbon\Carbon;
use Closure;
...
class NotifynderBuilder implements ArrayAccess
{
     ...
     *
     * @return $this
     * @throws \Boparaiamrit\Notifynder\Exceptions\IterableIsEmptyException
     * @throws \Boparaiamrit\Notifynder\Exceptions\EntityNotIterableException
     */
